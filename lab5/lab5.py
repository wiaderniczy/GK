...
light_position = [0.0, 0.0, 15.0, 1.0]
...
def render(time):
    ...
    show_light(light_position[0], light_position[1], light_position[2])
    show_light(light_position_2[0], light_position_2[1], light_position_2[2])
